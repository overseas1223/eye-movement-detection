...
camera = cv.VideoCapture("facil.webm") # "todos.webm", t118.mp4 ou "t039.mp4")
_, frame = camera.read()
...
np.savetxt("resultado_eu_medio.csv", matrizeu, delimiter=" ; ", fmt='%s')
np.savetxt("resultado_pc_medio.csv", matrizpc, delimiter=" ; ", fmt='%s')
